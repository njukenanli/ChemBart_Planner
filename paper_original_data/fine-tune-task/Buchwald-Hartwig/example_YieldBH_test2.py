...
# ================= TEST =================
print("\nTEST...")
TEST_DATA_PATH = "data/yield/bh_C_N_yield/MFF_Test2/test.json"
...
test_data_norm = prepare_data_for_model(data_list, global_mean, global_std)
